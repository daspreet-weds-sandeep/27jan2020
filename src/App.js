...
function App() {
  ...
  useEffect(() => {
    const countDownDate = new Date("Jan 27, 2020").getTime();
    ...
    <Fragment>
        ...
        <div className="container">
          <div className="media-container-row">
            <div className="title col-12 col-md-8">
              <h2 className="align-center pb-3 mbr-fonts-style display-1">Daspreet Kaur</h2>
              <h3 className="align-center mbr-light mbr-fonts-style display-7">
                D/o Sdn. Surinder Mohan Kaur & S. Gurmeet Singh
              </h3>
            </div>
          </div>
        </div>
      ...
      <section className="mbr-section content4 cid-qIifwA2R02" id="content4-4" style={{ paddingTop: "50px", paddingBottom: "80px" }}>
        <div className="container">
          <div className="media-container-row">
            <div className="title col-12 col-md-8">
              <h2 className="align-center pb-3 mbr-fonts-style display-1">Sandeep Singh Dehar</h2>
              <h3 className="align-center mbr-light mbr-fonts-style display-7">
                S/o Sdn. Surinder Kaur & S. Kesar Singh </h3>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="map1 cid-qIiXmYb55q" id="map1-b">
        <div className="google-map">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3430.9945355627974!2d75.79656064398192!3d30.690429837191903!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39107b614429c59d%3A0xb3dab395ea6af529!2sAhmedgarh%20-%20Dhulkot%20Rd%2C%20Punjab!5e0!3m2!1sen!2sin!4v1578914063777!5m2!1sen!2sin" width="600" height="450" frameborder="0" style={{ "border": "0px" }} allowfullscreen=""></iframe>
        </div>
      </section>
            ...
            <div className="row row-copirayt">
              <p className="mbr-text mb-0 mbr-fonts-style mbr-white align-center display-7">
                © Copyright 2020 Gurpreet Singh - All Rights Reserved
                    <br />
                Made with lots of <span className="fa fa-heart pulse2"></span> for his Sister
                </p>
            </div>
          </div>
        </div>
